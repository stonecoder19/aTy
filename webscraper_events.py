...
class WebScraper:
	...
	def parse_events(self):
		...
		event_titles = soup.find_all('div', class_='views-field views-field-title')
		event_dates = soup.find_all('div', class_ ='views-field views-field-field-event-datetime')
		event_summaries = soup.find_all('div', class_ ='views-field views-field-body')
...
class Event:
	...
	def print_event(self):
		return "Title: " + str(self.title) +" Date: " + str(self.date) + " Summary: " + str(self.summary)
